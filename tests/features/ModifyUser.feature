...
When I make a PUT request with the user information to "http://localhost:8000/users/user" with original email "joe@mail.ca" and new email "", username "" and password "newpass"
...
When I make a PUT request with the user information to "http://localhost:8000/users/user" with original email "joe@mail.ca" and new email "", username "adam" and password "newpass"
...
When I make a PUT request with the user information to "http://localhost:8000/users/user" with original email "joe@mail.ca" and new email "adam@mail.ca", username "adam" and password "newpass"
Then the response status code should be 200
And the response should contain a status message "Success"
And the response should contain a message "User modified successfully"
...
When I make a PUT request with the user information to "http://localhost:8000/users/user" with original email "adam@mail.ca" and new email "", username "" and password "newpass"
